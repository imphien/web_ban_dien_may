...
if(isset($_GET['id'])){
	...
	$sql_chitiet = mysqli_query($conn, "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.sanpham_id = '$id'");
?>
			...
			<div class="row">
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<div class="product-single-w3l">
						...
						<P><?php echo $row_chitiet['sanpham_mota']; ?>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="hidden" name="gia" value="<?php echo $row_chitiet['sanpham_gia']; ?>" />
