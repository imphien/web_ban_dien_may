										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<form action="?quanly=giohang" method="post">
												<fieldset>
													...
													<input type="hidden" name="gia" value="<?php echo $row_sanpham['sanpham_gia']; ?>" />
						...
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								...
								<?php
									...
									$sql_product_sidebar = mysqli_query($conn, "SELECT * FROM tbl_sanpham WHERE sanpham_hot = '1' ORDER BY sanpham_id DESC");
								...
								?>
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<del><?php echo number_format($row_product_sidebar['sanpham_gia']).'VND'; ?></del>
										</div>
									</div>
								<?php } ?>
								</div>
