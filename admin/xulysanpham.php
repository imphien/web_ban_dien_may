            ...
            <?php
                ...
                if($capnhat=='capnhat'){
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="capnhatsanpham" value="Cập nhật sản phẩm" class="btn btn-defaul">
                    </form>
                </div><br>
               <?php }else{ ?>
                    <div class="col-md-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="themsanpham" value="Thêm sản phẩm" class="btn btn-defaul">
                    </form>
                </div>
